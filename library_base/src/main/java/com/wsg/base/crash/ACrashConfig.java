...
public class ACrashConfig implements Serializable {
    ...
    private ACrashActivityOnCrash.EventListener eventListener = null;
    ...
    @Nullable
    public ACrashActivityOnCrash.EventListener getEventListener() {
        return eventListener;
    }

    public void setEventListener(@Nullable ACrashActivityOnCrash.EventListener eventListener) {
        this.eventListener = eventListener;
    }

    public static class Builder {
        private ACrashConfig config;

        @NonNull
        public static Builder create() {
            Builder builder = new Builder();
            ACrashConfig currentConfig = ACrashActivityOnCrash.getConfig();

            ACrashConfig config = new ACrashConfig();
         ...
         * The default is R.drawable.acrash_error_image (a cute upside-down bug).
         */
        @NonNull
         ...
         */
        @NonNull
        public Builder eventListener(@Nullable ACrashActivityOnCrash.EventListener eventListener) {
        ...
        @NonNull
        public ACrashConfig get() {
            return config;
        }

        public void apply() {
            ACrashActivityOnCrash.setConfig(config);
        }
    }
