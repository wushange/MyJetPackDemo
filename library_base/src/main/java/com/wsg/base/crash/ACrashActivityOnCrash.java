...
public final class ACrashActivityOnCrash {
    ...
    private static ACrashConfig config = new ACrashConfig();
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            if (config.isEnabled()) {
                                ...
                                if (hasCrashedInTheLastSeconds(application)) {
                                    ...
                                    } else if (config.getBackgroundMode() == ACrashConfig.BACKGROUND_MODE_SHOW_CUSTOM || !isInBackground) {
                                    ...
                                    } else if (config.getBackgroundMode() == ACrashConfig.BACKGROUND_MODE_CRASH) {
                                        if (oldHandler != null) {
                                            oldHandler.uncaughtException(thread, throwable);
                                            return;
                                        }
    ...
    public static String getStackTraceFromIntent(@NonNull Intent intent) {
        return intent.getStringExtra(ACrashActivityOnCrash.EXTRA_STACK_TRACE);
    }
     ...
     */
    @NonNull
    public static ACrashConfig getConfigFromIntent(@NonNull Intent intent) {
        return (ACrashConfig) intent.getSerializableExtra(ACrashActivityOnCrash.EXTRA_CONFIG);
    }
    ...
    public static String getActivityLogFromIntent(@NonNull Intent intent) {
        return intent.getStringExtra(ACrashActivityOnCrash.EXTRA_ACTIVITY_LOG);
    }
     ...
     */
    public static void restartApplicationWithIntent(@NonNull Activity activity, @NonNull Intent intent, @NonNull ACrashConfig config) {
    ...
    public static void restartApplication(@NonNull Activity activity, @NonNull ACrashConfig config) {
     ...
     * @param config   The config object as obtained by calling getConfigFromIntent.
     */
    public static void closeApplication(@NonNull Activity activity, @NonNull ACrashConfig config) {
        if (config.getEventListener() != null) {
    ...
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    @NonNull
    public static ACrashConfig getConfig() {
        return config;
    }
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static void setConfig(@NonNull ACrashConfig config) {
        ACrashActivityOnCrash.config = config;
    }
    ...
    private static Class<? extends Activity> guessErrorActivityClass(@NonNull Context context) {
        ...
        if (resolvedActivityClass == null) {
            resolvedActivityClass = ACrashDefaultErrorActivity.class;
        }
