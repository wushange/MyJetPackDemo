...
public final class AUICollapsingTextHelper {
    ...
    public AUICollapsingTextHelper(View view) {
        mView = view;
    ...
    public void setCollapsedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(mView.getContext(), resId, R.styleable.AUITextAppearance);
        if (a.hasValue(R.styleable.AUITextAppearance_android_textColor)) {
            mCollapsedTextColor = a.getColorStateList(R.styleable.AUITextAppearance_android_textColor);
        }
        if (a.hasValue(R.styleable.AUITextAppearance_android_textSize)) {
            mCollapsedTextSize = a.getDimensionPixelSize(R.styleable.AUITextAppearance_android_textSize,
                    (int) mCollapsedTextSize);
        }
        mCollapsedShadowColor = a.getInt(R.styleable.AUITextAppearance_android_shadowColor, 0);
        mCollapsedShadowDx = a.getFloat(R.styleable.AUITextAppearance_android_shadowDx, 0);
        mCollapsedShadowDy = a.getFloat(R.styleable.AUITextAppearance_android_shadowDy, 0);
        mCollapsedShadowRadius = a.getFloat(R.styleable.AUITextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    public void setExpandedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(mView.getContext(), resId, R.styleable.AUITextAppearance);
        if (a.hasValue(R.styleable.AUITextAppearance_android_textColor)) {
            mExpandedTextColor = a.getColorStateList(R.styleable.AUITextAppearance_android_textColor);
        }
        if (a.hasValue(R.styleable.AUITextAppearance_android_textSize)) {
            mExpandedTextSize = a.getDimensionPixelSize(R.styleable.AUITextAppearance_android_textSize,
                    (int) mExpandedTextSize);
        }
        mExpandedShadowColor = a.getInt(
                R.styleable.AUITextAppearance_android_shadowColor, 0);
        mExpandedShadowDx = a.getFloat(
                R.styleable.AUITextAppearance_android_shadowDx, 0);
        mExpandedShadowDy = a.getFloat(
                R.styleable.AUITextAppearance_android_shadowDy, 0);
        mExpandedShadowRadius = a.getFloat(
                R.styleable.AUITextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    public void setExpansionFraction(float fraction) {
        fraction = AUILangHelper.constrain(fraction, 0f, 1f);
