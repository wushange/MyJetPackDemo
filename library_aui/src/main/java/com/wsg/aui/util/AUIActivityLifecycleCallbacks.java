...
public abstract class AUIActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {

    private final Activity mTargetActivity;

    public AUIActivityLifecycleCallbacks(Activity targetActivity) {
