...
public class AUIKeyboardHelper {
    /**
     * 显示软键盘的延迟时间
     */
    public static final int SHOW_KEYBOARD_DELAY_TIME = 200;
    private static final String TAG = "AUIKeyboardHelper";
    ...
    public static void setVisibilityEventListener(final Activity activity,
        ...
        final View activityRoot = AUIViewHelper.getActivityRoot(activity);
        ...
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener =
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    private final int visibleThreshold = Math.round(
                            AUIDisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
        ...
        activity.getApplication()
                .registerActivityLifecycleCallbacks(new AUIActivityLifecycleCallbacks(activity) {
                    @Override
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        View activityRoot = AUIViewHelper.getActivityRoot(activity);
        int visibleThreshold =
                Math.round(AUIDisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
