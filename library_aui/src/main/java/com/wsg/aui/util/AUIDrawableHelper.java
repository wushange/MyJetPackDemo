 ...
 * @date 2016-03-17
 */
public class AUIDrawableHelper {
    private static final String TAG = AUIDrawableHelper.class.getSimpleName();
    ...
    public static Bitmap createBitmapFromView(View view, int leftCrop, int topCrop, int rightCrop, int bottomCrop) {
        Bitmap originBitmap = AUIDrawableHelper.createBitmapFromView(view);
