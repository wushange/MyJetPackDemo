 ...
 * @date 2016-03-27
 */
public class AUIStatusBarHelper {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(AUIDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (AUIDeviceHelper.isFlymeLowerThan8() || (AUIDeviceHelper.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    private static boolean Android6SetStatusBarLightMode(Window window, boolean light) {
        ...
        if (AUIDeviceHelper.isMIUIV9()) {
            // MIUI 9 低于 6.0 版本依旧只能回退到以前的方案
            // https://github.com/Tencent/AUI_Android/issues/160
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (AUIDeviceHelper.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return AUIDeviceHelper.isMIUIV5() || AUIDeviceHelper.isMIUIV6() ||
                AUIDeviceHelper.isMIUIV7() || AUIDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(AUIDeviceHelper.isZUKZ1() || AUIDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (AUIDeviceHelper.isTablet(context)
                && sStatusbarHeight > AUIDisplayHelper.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
