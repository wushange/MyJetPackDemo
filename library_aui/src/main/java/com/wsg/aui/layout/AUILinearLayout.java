...
public class AUILinearLayout extends AUIAlphaLinearLayout implements IAUILayout {
    private AUILayoutHelper mLayoutHelper;

    public AUILinearLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public AUILinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public AUILinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
