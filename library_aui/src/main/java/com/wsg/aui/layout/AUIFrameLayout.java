...
public class AUIFrameLayout extends AUIAlphaFrameLayout implements IAUILayout {
    private AUILayoutHelper mLayoutHelper;

    public AUIFrameLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public AUIFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public AUIFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new AUILayoutHelper(context, attrs, 0, this);
