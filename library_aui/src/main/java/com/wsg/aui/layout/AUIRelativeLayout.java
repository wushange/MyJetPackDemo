...
public class AUIRelativeLayout extends AUIAlphaRelativeLayout implements IAUILayout {
    private AUILayoutHelper mLayoutHelper;

    public AUIRelativeLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public AUIRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public AUIRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new AUILayoutHelper(context, attrs, defStyleAttr, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @AUILayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @AUILayoutHelper.HideRadiusSide int hideRadiusSide) {
