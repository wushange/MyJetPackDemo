...
public class AUIAlphaViewHelper {
	...
	public AUIAlphaViewHelper(@NonNull View target) {
		mTarget = new WeakReference<>(target);
		mPressedAlpha = getAttrFloatValue(target.getContext(), R.attr.aui_alpha_pressed);
		mDisabledAlpha = getAttrFloatValue(target.getContext(), R.attr.aui_alpha_disabled);
	}
	...
	public AUIAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
		mTarget = new WeakReference<>(target);
