...
import com.wsg.aui.layout.AUIFrameLayout;
import com.wsg.aui.util.AUIWindowInsetHelper;
 ...
 * 当windowInsets.bottom > 100dp的时候，我们认为是弹起了键盘。一旦弹起键盘，那么将由AUIWindowInsetLayout消耗掉，其子view的windowInsets.bottom传递为0
 *
 * @author cginechen
 * @date 2016-03-25
 */
public class AUIWindowInsetLayout extends AUIFrameLayout implements IWindowInsetLayout {
    protected AUIWindowInsetHelper mAUIWindowInsetHelper;

    public AUIWindowInsetLayout(Context context) {
        this(context, null);
    }

    public AUIWindowInsetLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AUIWindowInsetLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mAUIWindowInsetHelper = new AUIWindowInsetHelper(this, this);
    }
    ...
    public boolean applySystemWindowInsets19(Rect insets) {
        return mAUIWindowInsetHelper.defaultApplySystemWindowInsets19(this, insets);
    }

    @Override
    public boolean applySystemWindowInsets21(Object insets) {
        return mAUIWindowInsetHelper.defaultApplySystemWindowInsets21(this, insets);
    }
